...
//         */
//        String data = description.substring(8, description.length() - 2);
...
//        String stripped = description.substring(8, length - 2);
//
...
//        for (k = 0; k < 35; k+=5)
//        {
//            cTarget = stripped.substring(k, k + 5);
